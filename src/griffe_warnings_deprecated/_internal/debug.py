...
def _get_version(dist: str = "griffe-warnings-deprecated") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["griffe-warnings-deprecated"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("GRIFFE_WARNINGS_DEPRECATED")]]
    return _Environment(
